...
class LauncherUIMixin:
    ...
    def _create_launcher_tab(self) -> QWidget:
        ...
        self.app_definitions = [
            ...
            # B116 (Bayram's list, 2026-09-10). Every one of these was
            # checked before it was written here: micromamba against
            # conda-forge, and PyPI directly. Only `git` turned out to be
            # installable at all, and it still belongs here -- see its note.
            #
            # THREE OF THEM HAVE A PyPI PACKAGE OF THE SAME NAME THAT IS NOT
            # THE APPLICATION: weka and knime are wrappers around Java
            # software, gpt4all is the bindings rather than the desktop app.
            # A card that pip-installed those would leave the user pressing
            # Launch on a library.
            {
                "name": "Visual Studio Code",
                "icon": "💠",
                "icon_key": "vscode",
                "env_types": ["venv", "uv", "hatch", "pdm", "poetry", "conda"],
                "package": "__system__",
                "system_app": True,
                "system_commands": {
                    "windows": ["code.exe"],
                ...
                "install_note": "Not in any conda channel (checked conda-forge on 2026-09-10). The pip name `code` is something else entirely.",
                "desc": "Code editor — extensions, debugger, integrated terminal",
                            },
            {
                "name": "Antigravity",
                "icon": "🪐",
                ...
                "download_url": "https://antigravity.google/product/antigravity-ide",
                "install_note": "Not in any conda channel. NOTE: `antigravity` on PyPI is Python's own joke module, not this.",
                "desc": "Google's agent-first IDE",
                            },
            {
                "name": "Weka",
                "icon": "🦜",
                ...
                "download_url": "https://ml.cms.waikato.ac.nz/weka/downloading.html",
                "install_note": "The PyPI package `weka` is a Python WRAPPER around the Java library, not the workbench itself. Installing it would give you an import, not an application.",
                "desc": "Machine learning workbench — classifiers, clustering, visualisation",
                            },
            {
                "name": "KNIME",
                "icon": "🧩",
                ...
                "download_url": "https://www.knime.com/downloads",
                "install_note": "The PyPI package `knime` reads and executes workflows; it is not the Analytics Platform.",
                "desc": "Visual data pipelines — drag-and-drop analytics",
                            },
            {
                "name": "Git",
                "icon": "🌿",
                ...
                "install_note": "conda-forge DOES carry git, but installing it into a Python environment gives you a copy that exists only inside that environment. Git is a system tool; install it once, system-wide.",
                "desc": "Version control — the tool VenvStudio's own commands assume",
                            },
            {
                "name": "Code::Blocks",
                "icon": "🧱",
                ...
                "system_app": True,
                "system_commands": {
                    "windows": ["codeblocks.exe"],
                    "linux":   ["codeblocks"],
                    "macos":   ["codeblocks"],
                },
                "download_url": "https://www.codeblocks.org/downloads/",
                "install_note": "Not in any conda channel.",
                "desc": "C/C++ IDE — the real one, with compiler integration",
                            },
            {
                "name": "GPT4All",
                "icon": "🧠",
                ...
                "download_url": "https://www.nomic.ai/gpt4all",
                "install_note": "The PyPI package `gpt4all` is the Python BINDINGS. The desktop application is a separate download.",
                "desc": "Run language models locally — desktop chat application",
                            },
            {
                "name": "Jan",
                "icon": "🌐",
                ...
                "download_url": "https://jan.ai/",
                "install_note": "Not on PyPI or in any conda channel.",
                "desc": "Offline ChatGPT alternative — runs models on your machine",
                            },
            {
                "name": "OpenCode",
                "icon": "⌨️",
                ...
                "install_note": "Not on PyPI or in any conda channel.",
                "desc": "Terminal-based coding agent",
                            },
            {
                "name": "RStudio",
                "icon": "🎯",
